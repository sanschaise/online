...
var tallyDeath = function() {
    ...
    for( var i = 0; i < deathsOf5; i++ ) {
        ...
        var tally = game.add.image( 300 + ( i * 80 ), 78 , 'spritesheet', 'tallies/tally5.png' );
    ...
    if( player.deaths % 5 ) {
        var tally = game.add.image( 300 + ( deathsOf5 * 80 ), 78 , 'spritesheet', 'tallies/tally' + ( player.deaths % 5 ) + '.png' );
        tally.fixedToCamera = true;
        bgElements.add( tally );
        player.tallies.push( tally );    
